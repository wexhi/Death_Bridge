...
//163.496 168.456 177.551 190.366 205.661 222.404 240.179 258.162 276.144 293.300 309.422 324.511 338.153 350.141 360.269 368.537 374.738 379.078
	...
	double LSpeed[24] = { 0.288, 0.518, 1.3, 1.3, 1.6, 1.736, 2, 2.166, 2.221, 2.346, 2.347, 2.428, 2.493, 2.545, 2.685, 2.716, 2.838, 2.65, 2.55, 2.40, 2.3, 2.3, 2.0, 1.9 };
	int time[24] = { 143, 147, 155, 166, 179, 194, 210, 225, 241, 256, 270, 283, 295, 306, 315, 322, 327, 331, 340, 350, 300, 250, 200, 200};
