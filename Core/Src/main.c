...
<<<<<<< HEAD
	...
	double LSpeed[25] = { 0.288, 0.518, 1.3, 1.3, 1.6, 1.736, 2, 2.166, 2.221, 2.346, 2.347, 2.428, 2.493, 2.545, 2.685, 2.716, 2.838 , 2.65, 2, 55,  2.40, 2.3,2.3,2.0,1.9};
	int time[25] = { 143, 147, 155, 166, 179, 194, 210, 225, 241, 256, 270, 283, 295, 306, 315, 322, 327, 331 , 340, 350, 300,250,200,200,250};
=======
>>>>>>> e2670d282a7c4d03d539047c56e2f3470f7d5a47
	double LSpeed[18] = { 0.288, 0.518, 0.853, 1.214, 1.549, 1.836, 2.073, 2.266, 2.421, 2.546, 2.647, 2.728, 2.793, 2.845, 2.885, 2.916, 2.938, 2.952 };
	int time[18] = { 143, 147, 155, 166, 179, 194, 210, 225, 241, 256, 270, 283, 295, 306, 315, 322, 327, 331 };
>>>>>>> 42e2a4cd30924134a49ca9ff5bf760fe98e61bc7
	int t = 0;
	while (t<25)
	{
		MotorPidSetSpeed(LSpeed[t],4.1);		
		HAL_Delay(time[t]);
		t++;
	}
//	t = 0;
//	double RSpeed[5] = { 4.4, 4.5, 4.6, 4.7, 4.8};
//	double time2[5]= { 300, 300, 300, 300, 300};
//	while (t < 5)
//	{
//		MotorPidSetSpeed(2.85, RSpeed[t]);
//		HAL_Delay(time2[t]);
//		t++;
//		
//	}
	
	MotorPidSetSpeed(2.1, 4);
	HAL_Delay(300);
	stop();
<<<<<<< HEAD
=======
